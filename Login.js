...
async function kirjaudu() {
    ...
    if (document.getElementById("nimi").value == localStorage.getItem("nimi") && (await häsh(document.getElementById("salasana").value)) == localStorage.getItem("salasana")) {
...
async function rekisteröidy() {
    ...
    if (reg == 1) {
        if (document.getElementById("nimi").value != "" && document.getElementById("salasana").value != "") {
            ...
            localStorage.setItem("salasana", await häsh(document.getElementById("salasana").value));
